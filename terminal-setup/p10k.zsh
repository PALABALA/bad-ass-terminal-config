# Generated by Powerlevel10k configuration wizard on 2022-05-01 at 23:12 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX="%F{red} \Uf1d0 %f %F{yellow}❯ "
  ...
  typeset -g POWERLEVEL9K_HISTORY_BACKGROUND='green'
